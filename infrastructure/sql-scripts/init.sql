-- ============================================
-- ARQUIVO: init.sql (VERSÃO BLINDADA)
-- ============================================
...
-- 1. LIMPEZA TOTAL (Ordem correta para não quebrar FKs)
DROP TABLE IF EXISTS status_prato_produto;
DROP TABLE IF EXISTS obs_prato_produto;
DROP TABLE IF EXISTS recuperacao_senha_token;
DROP TABLE IF EXISTS item_carrinho;
DROP TABLE IF EXISTS pedido_prato_produto;
DROP TABLE IF EXISTS venda;
DROP TABLE IF EXISTS prato;
DROP TABLE IF EXISTS produto;
DROP TABLE IF EXISTS categoria;
DROP TABLE IF EXISTS setor;
DROP TABLE IF EXISTS area_preparo;
DROP TABLE IF EXISTS funcionario;
DROP TABLE IF EXISTS gerenciamento_plano;
DROP TABLE IF EXISTS plano_template;
...
-- 2. Tabela PLANO_TEMPLATE (ATUALIZADA)
CREATE TABLE IF NOT EXISTS plano_template (
    id INT PRIMARY KEY AUTO_INCREMENT,
    tipo VARCHAR(255),
    descricao VARCHAR(255),
    preco_mensal DECIMAL(38,2),
    preco_mensal_com_desconto_anual DECIMAL(38,2),
    preco_anual DECIMAL(38,2),
    qtd_usuarios INT,
    qtd_super_usuarios INT,
    acesso_relatorio_whats_app BOOLEAN,
    acesso_dashboard BOOLEAN
)
CHARACTER SET utf8mb4 
COLLATE utf8mb4_general_ci;

-- 3. Tabela GERENCIAMENTO_PLANO
CREATE TABLE IF NOT EXISTS gerenciamento_plano (
    id INT PRIMARY KEY AUTO_INCREMENT,
    periodo VARCHAR(50), -- Enum Periodo
    data_adesao DATE,
    data_inicio DATE,
    data_fim DATE,
    ...
    dias_teste INT,
    ativo BOOLEAN,
    valor_cobrado DECIMAL(38,2),
    empresa_id INT UNIQUE, -- OneToOne com Empresa
    plano_template_id INT,
    FOREIGN KEY (empresa_id) REFERENCES empresa(id),
    FOREIGN KEY (plano_template_id) REFERENCES plano_template(id)
)
CHARACTER SET utf8mb4 
COLLATE utf8mb4_general_ci;
...
-- 11. Tabela PEDIDO_PRATO_PRODUTO
...
-- 13. Tabela RECUPERACAO_SENHA_TOKEN
...
-- 15. Tabela STATUS_PRATO_PRODUTO
...
-- Convertendo as tabelas
ALTER TABLE empresa CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE plano_template CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE gerenciamento_plano CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE funcionario CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE area_preparo CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE setor CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE prato CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE venda CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE pedido_prato_produto CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE item_carrinho CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE recuperacao_senha_token CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE obs_prato_produto CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
ALTER TABLE status_prato_produto CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- ============================================
--              INSERT DE DADOS
-- ============================================

-- [NOVO] INSERÇÃO DOS TEMPLATES DE PLANO
-- 1. ESSENCIAL
...
-- 3. PREMIUM (QTD_USUARIOS = ilimitado -> 2147483647)
INSERT INTO plano_template(acesso_dashboard, acesso_relatorio_whats_app, preco_anual, preco_mensal, preco_mensal_com_desconto_anual, qtd_super_usuarios, qtd_usuarios, descricao, tipo)
